...
BibOptions(check.entries = FALSE,
           ...
           max.names = 2)
myBib <- ReadBib(file = "../refs.bib", check = FALSE)
```
...
The analysis can emphasise data processing, statistical analysis, visualisation or any combination of these.

--

You **must** use RStudio projects and rmarkdown (any, incl. Shiny), organise your analyses for reproducibility and follow good practice.
...
-  Spring Weeks 1 - 2: Project work. Drop-ins
-  Spring Week 3: Assessment deadline Monday 1200 noon
]
