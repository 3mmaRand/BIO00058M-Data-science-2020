...
You will learn about using RStudio projects in week 4.
...
In week 4 you will learn about the `here` package `r Cite(myBib, "R-here")` to construct file paths relative to your RStudio project.
