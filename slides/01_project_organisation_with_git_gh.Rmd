...
This slide show introduces a workflow for project organisation using a version controlled RStudio Project with a remote repo on GitHub.
...
One science research project might have several organisational projects associated with it. For example, projects for each of:
...
* Use an RStudio Project or similar (many IDEs have them)  
...
Project is obviously a commonly used word. When I am referring to an [RStudio Project](https://support.rstudio.com/hc/en-us/articles/200526207-Using-Projects) I will use the capitalised words 'RStudio Project'.
...
For example, if you create an RStudio Project called `stem_cell_rna` then your folder structure would look something like this:
