...
The aim of this section is to introduce you to the tidyverse `r Cite(myBib, "Wickham2019-ml")` including the pipe, `%>%`  and some commonly applied data tidying operations.
...
`r emo::ji("clapper")` Start a new project containing directories called scripts, data-raw, and data-processed. Use a new script for example. 
...
* **`tidybulk`** `r Cite(myBib, "R-tidybulk")`. See also https://stemangiola.github.io/rpharma2020_tidytranscriptomics/articles/tidytranscriptomics.html
...
tidyverse import functions treat strings as character variables by default, not factors. Until R 4.x, `read.table()` turned strings into factors. This used to be an important reason for me to use `read_table2()`.
...
```{r echo=FALSE}
file <- "../data-processed/biomass2-base.txt"
...
See the result: [biomass2-base.txt](../data-processed/biomass2-base.txt)

`r kableExtra::text_spec("Extra exercise:", background = "#25496b", color = "#fdf9f6", bold = TRUE)` Can you find a tidyverse function for writing dataframes.
